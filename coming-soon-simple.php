<?php
/*
Plugin Name: Coming soon simple
Plugin URI:  https://wordpress.org/plugins/coming-soon-simple/
Description: Comming soon plugin allows you to quickly  launch under construction page for your website. Collect E-mails and connect with users on Social Networks.
Version:     1.0 
Author:      Abhay Yadav
...
function cmgs_menu()
{
	...
	$menu = add_menu_page(__('Coming soon','coming-soon'), __('Coming soon','coming-soon'),'administrator', 'coming_soon',	'construction');
...
{  
   require "theme_options/abhay_option_pannel.php"; 
}
